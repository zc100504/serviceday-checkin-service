...
ALLOWED_HOSTS = os.environ.get('CHECKIN_SERVICE_URL', '127.0.0.1 localhost').split()
...
MIDDLEWARE = [
    ...
    'checkin.middleware.SecurityMiddleware', 
]
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'checkin.authentication.StatelessJWTAuthentication',
    ),
